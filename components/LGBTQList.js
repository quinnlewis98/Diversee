...
import {View,Text, StyleSheet, FlatList, Button, Linking, Platform,} from 'react-native'; 
...
function mapStateToProps(state) {
    return {
      lgbtqData: state.myData.filter(item => item.lgbtqowned == 1),
      userLat: state.userLat,
      userLong: state.userLong
    };
  }

export default connect(mapStateToProps)(LGBTQList);

function LGBTQList(props) {  
